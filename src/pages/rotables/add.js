          ...
          <form id={`#${modalNumber}form`} onSubmit={this.save}>
            <div className="modal-content bg-secondary">
              <div className="modal-header">
                <h4 className="modal-title">Create Rotable</h4>
              ...
              <div className="modal-body">
                <div className="row">
                  ...
                  <div className="col-md-6 col-lg-6">
                    <div className="form-group">
                      <input required type="text" className="form-control form-control-alternative" placeholder="Part Number" value={this.state.part_no} onChange={e => this.setState({ part_no: e.target.value })} />
                    </div>
                  </div>
                  <div className="col-md-6 col-lg-6">
                    <div className="form-group">
                      <input required type="text" className="form-control form-control-alternative" placeholder="Serial Number" value={this.state.serial_no} onChange={e => this.setState({ serial_no: e.target.value })} />
                    </div>
                  </div>
                </div>
              </div>
