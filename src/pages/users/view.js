          ...
          <div className="card-header">
            <div className="row d-flex justify-content-between">
              ...
              <div className="ml-auto">
                ...
                <button className="btn btn-outline-secondary" onClick={() => {setRemove(data.user); deleteModalInstance.show()}}>
          ...
          <div className="card-body">
            <div className="row">
              ...
              <div className="col-8 col-lg-9" style={{ borderLeft: "1px solid var(--lighter)"}}>
                ...
                <hr/>
                <h3>Contact: {data.user.contact}</h3>
                <h3>Department: {data.user.department.name}</h3>
                <h3>Role: {data.user.type}</h3>
              </div>
            </div>
          </div>
        </div>
