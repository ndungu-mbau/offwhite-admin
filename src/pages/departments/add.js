...
import AddModal from './add_hod'

const modalNumber = Math.random().toString().split(".")[1];
const $ = window.$;
const addInstance = new AddModal()
  ...
  render(){
    return (
      <div className="modal fade" id={modalNumber} tabIndex="-1" role="dialog"aria-hidden="true">
        <AddModal save={this.saveHod} roles={this.props.roles} />
              ...
              <div className="modal-body">
                <div className="row">
                  ...
                  <div className="col-md-9 col-lg-9">
                    <div className="form-group">
                      ...
                      >
                        ...
                        {this.props.users.filter(user => user.type === "HOD").map(user => (
                  ...
                  <div className="col-md-3 col-lg-3">
                    <button type="button" className="btn btn-secondary" onClick={addInstance.show}>
